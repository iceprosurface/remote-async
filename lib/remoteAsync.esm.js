...
class RemoteAsyncObject {
    constructor(guid, promise, eject, resolve) {
        ...
        this.promiseType = PROMISE_TYPE.pending;
    }
    judge(data, parser) {
...
class Server {
    ...
    emit(target, remoteData, data) {
        ...
        (_a = this.listeners[target]) === null || _a === void 0 ? void 0 : _a.forEach((fn) => {
            ...
            fn(data, (ret) => sendTo(ret, PROMISE_TYPE.resolve), (ret) => sendTo(ret, PROMISE_TYPE.reject), remoteData);
        });
    }
...
export { PROMISE_TYPE, RemoteAsyncObject, Server };
